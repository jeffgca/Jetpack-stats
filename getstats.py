...
<ul>
    ...
    <li>Bugs <a href="https://bugzilla.mozilla.org/buglist.cgi?chfieldto={{ range_to }}&chfield=[Bug%20creation]&chfieldfrom={{ range_from }}&product=Add-on%20SDK" target="_blank">created this week</a>: {{ new }}</li>
    <li>Bugs <a href="https://bugzilla.mozilla.org/buglist.cgi?chfieldto={{ range_to }}&chfield=resolution&chfieldfrom={{ range_from }}&chfieldvalue=FIXED&product=Add-on%20SDK" target="_blank">fixed this week</a>: {{ fixed }}</li>
...
<em style="font-size: 85%;">Note: the stats above are based on the queries I linked to
for each item. If you have suggestions on how these queries might be made more accurate,
please comment below. Stats generated at {{ run_time }}</em>
"""
